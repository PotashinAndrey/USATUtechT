  ...
  export default async function main(canvas, width, height) {
    ...
    const programInfo = {
      ...
      attribute: {
        ...
        vertexTextre: gl.getAttribLocation(program, 'aTextureCoord')
      },
      uniform: {
...
/** */
  function initBuffers(gl) {
    ...
    return {
      ...
      textures: {buffer: textureBuffer, length: textureCoords.length}
    };
  }
...
/** */
  function drawScene(gl, programInfo, buffers, cubeRotation, light, crateImage) {
    ...
    {
      gl.bindBuffer(gl.ARRAY_BUFFER, buffers.textures.buffer);
      gl.vertexAttribPointer(programInfo.attribute.vertexTextre, buffers.textures.buffer.itemSize, gl.FLOAT, false, 0, 0);
